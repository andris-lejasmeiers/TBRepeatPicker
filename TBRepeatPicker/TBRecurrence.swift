...
open class TBRecurrence: NSObject {
    ...
    */
    open var frequency: TBRPFrequency = .daily
    ...
    */
    open var selectedMonthdays = [Int]() {
        didSet {
    ...
    */
    open var pickedWeekNumber: TBRPWeekPickerNumber = .first
    ...
    * TBRPWeekPickerDay.WeekendDay
    ...
    This property value is valid only for a frequency type of TBRPFrequency.Monthly or TBRPFrequency.Yearly.
    */
    open var pickedWeekday: TBRPWeekPickerDay = .sunday
